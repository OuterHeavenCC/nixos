...
in
{
  ...
  home.file."${config.xdg.configHome}/lvim/spell/fr.utf-8.sug".source =
    nvim-spell-fr-utf8-suggestions;
  home.file."${config.xdg.configHome}/lvim/spell/fr.latin1.spl".source =
    nvim-spell-fr-latin1-dictionary;
  home.file."${config.xdg.configHome}/lvim/spell/fr.latin1.sug".source =
